...
import { Pool } from 'pg';
export var DrizzleAsyncProvider = 'DrizzleAsyncProvider';
export var drizzleProvider = [
    {
        inject: [ConfigService],
        provide: DrizzleAsyncProvider,
        useFactory: function (configService) { return __awaiter(void 0, void 0, void 0, function () {
            var connectionString, pool, _drizzle;
            return __generator(this, function (_a) {
                connectionString = configService.get('DATABASE_URL');
                pool = new Pool({ connectionString: connectionString });
                _drizzle = drizzle(pool, { casing: 'snake_case', schema: schema });
